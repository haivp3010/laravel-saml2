...
return $settings = array(
    ...
    'sp' => array(
        ...
        'NameIDFormat' => env('SAML2_NAMEID_FORMAT', 'urn:oasis:names:tc:SAML:2.0:nameid-format:persistent'),
    ...
    'idp' => array(
        ...
        'singleSignOnService' => array(
            ...
            // using HTTP-Redirect binding.
            'url' => $idp_host . env('SAML2_SSO_ENDPOINT', '/saml2/idp/SSOService.php'),
        ),
        // SLO endpoint info of the IdP.
        'singleLogoutService' => array(
            // URL Location of the IdP where the SP will send the SLO Request,
            // using HTTP-Redirect binding.
            'url' => $idp_host . env('SAML2_SLO_ENDPOINT', '/saml2/idp/SingleLogoutService.php'),
        ),
